...
class ProductNatureRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'productNatureAttribute_ids.*.id' => $this->isMethod('POST') ? 'required|integer|exists:product_nature_attributes,id' : 'nullable|integer|exists:product_nature_attributes,id',
